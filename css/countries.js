...
// Countries
var country_arr = new Array("1st Sem", "2nd Sem");

// States
var s_a = new Array();
s_a[0]="";
s_a[1]="Engg.Mathamatics-I|Engg. Materials & Applications|Computer Concept & Programing|Engg. Chemistry|Ele. of Elec. & Electro. Engg|Environment Engg.";
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Select Semester','-1');
